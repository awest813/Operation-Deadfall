...
void M_Menu_Teamplay_Items_Powerups_f (void)
{
	...
	menubulk_t bulk[] =
	{
		...
		MB_EDITCVARSLIM("Pentagram", "tp_name_pent", "Short name for Pentagram of Protection"),
		MB_EDITCVARSLIM("Ring of Invis", "tp_name_ring", "Short name for Ring of Invisibility"),
		MB_EDITCVARSLIM("Suit", "tp_name_suit", "Short name for Environment Suit"),
		MB_SPACING(4),
		MB_EDITCVARSLIM("Quaded", "tp_name_quaded", "Short name for reporting being 'Quaded' (killed by a player with Quad Damage)"),
		MB_EDITCVARSLIM("Pented", "tp_name_pented", "Short name for reporting being 'Pented' (killed by a player with the Pentagram)"),
		MB_EDITCVARSLIM("Eyes (Ringed)", "tp_name_eyes", "Short name for reporting being 'Ringed' (killed by a player with the Ring of Invisibility)"),
		MB_SPACING(4),
